...
(function () {
    ...
    function loadCountryListData(datas) {
        ...
        for (let index = 0; index < arr.length; index++) {
            ...
            <div class="flex-shrink-0 me-2"><img src="'+ domain + arr[index]['flagImg'] + '" alt="country flag" class="options-flagimg" height="20"></div>\
        ...
        Array.from(item.querySelectorAll(".dropdown-menu li")).forEach(function (subitem) {
            ...
            subitem.addEventListener("click", function () {
                ...
                if (item.querySelector("button")) {
                    ...
                    item.querySelector("button img").nextElementSibling.value = optionFlagImg;
                    if (item.querySelector("button span")) {
                        item.querySelector("button span").innerHTML = optionCodeNo;
                        item.querySelector("button span").nextElementSibling.value = optionCodeNo;
                    }
                }
            });
            ...
            searchInput.addEventListener("keyup", function () {
                ...
                setTimeout(function () {
                    ...
                    Array.from(filterData).forEach(function (listData) {
                        ...
                        <div class="flex-shrink-0 me-2"><img src="'+ domain + listData.flagImg + '" alt="country flag" class="options-flagimg" height="20"></div>\
                        <div class="flex-grow-1">\
